...
\begin{equation}
\alpha_i=\frac{1}{2}\cdot\ln(\frac{1-err_i}{err_i})
\end{equation}
...
\begin{subequations}
\begin{align}
\lambda_{i+1}&=\lambda_i\cdot\frac{1}{2\cdot(1-err_i)}, &if~h^{selector}_{i}~correct\\
\lambda_{i+1}&=\lambda_i\cdot\frac{1}{2\cdot err_i}, &if~h^{selector}_{i}~wrong
\end{align}
\end{subequations}
\end{itemize}
