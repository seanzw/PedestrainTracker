...
\begin{figure}[htb]
    \begin{center}
        \subfigure[Initialization of Multiple Tracker]{\label{fig:sub:multiTrackerInit}
            \begin{minipage}[c]{0.5\textwidth}
            \centering
            \includegraphics[width = \textwidth]{images/MultiTrackerInit01.png}
            \end{minipage}%
        }%
        \subfigure[Tracker lost its target.]{\label{fig:sub:multiTrackerLost}
            \begin{minipage}[c]{0.5\textwidth}
            \centering
    ...
    \end{center}
    \caption{Result of Multiple Tracker}
...
\begin{figure}[htb]
    \begin{center}
         \subfigure[MultipleTracker]{\label{fig:sub:multiTracker}
            \begin{minipage}[c]{0.5\textwidth}
            \centering
            \includegraphics[width = \textwidth]{images/MultiTracker01.png}
            \end{minipage}%
        }%
        \subfigure[Energy Minimization]{\label{fig:sub:energyMin}
            \begin{minipage}[c]{0.5\textwidth}
            \centering
            \includegraphics[width = \textwidth]{images/EnergyMin01.png}
            \end{minipage}%
        }%
    \end{center}
    \caption{CountResult}
